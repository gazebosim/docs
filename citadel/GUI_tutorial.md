...
The grid visible in the scene is actually a plugin with adjustable settings.
...
Now that you're comfortable with Ignition GUI navigation and terminology, let's start learning about more meaningful model interactions with the [Manipulating Models](/citadel/Manipulating_models) tutorial.
