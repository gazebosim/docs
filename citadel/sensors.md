...
You can find the final world of this tutorial [here](https://github.com/ignitionrobotics/docs/blob/master/citadel/tutorials/sensors/sensor_tutorial.sdf)
...
[moving_robot.sdf](https://github.com/ignitionrobotics/docs/blob/master/citadel/tutorials/moving_robot/moving_robot.sdf) world and modify it. Create a new file
...
We need also to add the `TouchPlugin` under the link in the `wall` model as follows:
