...
You can find the final world of this tutorial showing all these plugins in use [here](https://github.com/gazebosim/docs/blob/master/rotary/tutorials/sensors/sensor_tutorial.sdf).
You may also find an extensive set of world examples with many possible sensors and actuation capabilities in [`gz-sim/examples/worlds`](https://github.com/gazebosim/gz-sim/tree/main/examples/worlds) for individual examples.
...
[moving_robot.sdf](https://github.com/gazebosim/docs/blob/master/rotary/tutorials/moving_robot/moving_robot.sdf) world and modify it. Create a new file
...
You can download the finished node for this demo from [here](https://github.com/gazebosim/docs/blob/master/rotary/tutorials/sensors/lidar_node.cc).
...
Download the [CMakeLists.txt](https://github.com/gazebosim/docs/blob/master/rotary/tutorials/sensors/CMakeLists.txt), and in the same folder of `lidar_node` create `build/` directory:
