...
[Gazebo Kura](https://gazebosim.org/).
...
Note: binaries for ROS2 might be available sometime after the Kura release.
...
Kura release this means that it will be adopted when ROS 2 Kilted goes into the
