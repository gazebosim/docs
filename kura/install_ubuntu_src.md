...
```bash
curl -O https://raw.githubusercontent.com/gazebo-tooling/gazebodistro/master/collection-kura.yaml
```
...
packages that compose the Kura collection. Every platform has a different
