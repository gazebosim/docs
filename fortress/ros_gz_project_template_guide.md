...
1. Choose a ROS and Gazebo combination  https://gazebosim.org/docs/fortress/ros_installation
...
3. Modify
   ...
   There are two primary mechanisms to integrate ROS 2 and Gazebo depending on your application:
    ...
    (https://gazebosim.org/api/sim/6/classignition_1_1gazebo_1_1EntityComponentManager.html) within a Gazebo plugin.
